...
<body>
		...
		<ul>
			...
			<li class="section" data-index="3" >
			 ...
			 <li class="section" data-index="4">
				...
				<div class="cont">
					<p><a href="chunv.php" data-index="4-1"><span class=" btn1"></span>A</a><span>一年以上</span></p>
					<p><a href="shuiping.php" data-index="4-2"><span class=" btn1"></span>B</a><span>一年以内</span></p>
				</div>
			</li>
			<li class="section" data-index="5">
				...
				<div class="cont">
					<p><a href="mojie.php" data-index="5-1"><span class=" btn1"></span>A</a><span>排名</span></p>
					<p><a href="jinniu.php" data-index="5-2"><span class=" btn1"></span>B</a><span>就业</span></p>
				</div>
			</li>
			<li class="section" data-index="6">
				...
				<div class="cont">
					<p><a href="tianping.php" data-index="6-1"><span class=" btn1"></span>A</a><span>你依赖的人</span></p>
			...
			<li class="section" data-index="8">
				...
				<div class="cont">
					<p><a href="shuangyu.php" data-index="8-1"><span class=" btn1"></span>A</a><span>善良感性，多愁善感 </span></p>
					<p><a href="juxie.php" data-index="8-2"><span class=" btn1"></span>B</a><span>外表强大，内心柔软</span></p>
				</div>
			</li>
			<li class="section" data-index="9">
				...
				<div class="cont">
					<p><a href="shizhi.php" data-index="9-1"><span class=" btn1"></span>A</a><span>会</span></p>
					<p><a href="tianxie.php" data-index="9-2"><span class=" btn1"></span>B</a><span>不会</span></p>
				</div>
			</li>
			...
			<li class="section" data-index="11">
				...
				<div class="cont">
					<p><a href="sheshou.php" data-index="11-1"><span class=" btn1"></span>A</a><span>研究型的</span></p>
					<p><a href="shuangzi.php" data-index="11-2"><span class=" btn1"></span>B</a><span>实用型的</span></p>
				</div>
			</li> 
		</ul>
	</div>
	...
	$(function(){
		var arr=[];
		$(".cont a .btn1").on("click",function(e){
			e.preventDefault();
			var _this=$(this),
