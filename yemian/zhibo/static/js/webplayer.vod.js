...
;(function(window,undefined){
	...
	window.webplayer = {
		...
		winSizeLimit : function(){
			...
			window.widgetCssOpts = {
				...
				videoAnim : {
					...
					"top" : this.config.top */
					"left" :(((document.body.clientWidth) ||(document.documentElement.clientWidth))-960)/2,
					"top" : (((document.body.clientHeight) ||(document.documentElement.clientHeight))-540)/2,
				},
				outlineCss : {
					"visibility" : "visible"
				},
		...
		videoInnerSize : function(){
			$(".player,#movieContrl2,#obx").height(0);
			$(".player,#movieContrl2,#obx").css({
