...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		var ind = $(element).parent().children().index(element);
		if(ind == 1){
			/* $(".fg").removeClass("fadeIn animated").addClass("hide"); //发光
			$(".qz").removeClass("zoomIn animated1").addClass("hide"); //红条
			$(".tips").removeClass("swing animated").addClass("hide"); //下面字体 */
			
			/* $(".fg").addClass("hide").removeClass("fadeIn animated");
			$(".qz").addClass("hide").removeClass("zoomIn animated1");
			$(".tips").addClass("hide").removeClass("swing animated");
			$(".fg,.qz,.tips").show();
			$(".z,.hand,.gg").fadeOut();
			$(".p2 .hb").adclass("on"); */
			
			set();
				 timer2=setTimeout(function(){ //展开
					$(".fg,.qz,.tips").hide();
					$(".hb1,.hb6,.hb7,.hb8,.hb5").addClass("on");
					$(".hb1,.hb22").removeClass("hb11");
					$(".z1,.z8,.z9").removeClass("on");
				},1000);
				 timer3=setTimeout(function(){ //合
					$(".hb1,.hb22").addClass("hb11");
					$(".p2 .hb").removeClass("on");
					 $(".z,.hand,.gg").hide();
					$(".fg,.qz,.tips").show();
					$(".fg").removeClass("hide").addClass("fadeIn animated");
					$(".qz").removeClass("hide").addClass("zoomIn animated1");
					$(".tips").removeClass("hide").addClass("swing animated");   
				},5000)  
			
			
			 timer2=setInterval(function(){
				timer4=setTimeout(function(){ //展开
					$(".hb1,.hb22").removeClass("hb11");
					$(".fg,.qz,.tips").hide();
					$(".hb").addClass("on");
					$(".z").fadeIn();
		...
		function set(){
			var w1=$(".qz img").width(),
				...
				ml1=-(w1/2),
				ml2=-(w2/2);
				//$(".qz").css({"marginLeft":ml1,"left":50+"%"});
				$(".fg").css({"marginLeft":ml2,"left":50+"%"});
		}
